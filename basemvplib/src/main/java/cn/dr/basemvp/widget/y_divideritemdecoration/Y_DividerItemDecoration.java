package cn.dr.basemvp.widget.y_divideritemdecoration;
...
public abstract class Y_DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (divider.getLeftSideLine().isHave()) {
                int lineWidthPx = CommonUtils.dp2px(divider.getLeftSideLine().getWidthDp());
                int startPaddingPx = CommonUtils.dp2px(divider.getLeftSideLine().getStartPaddingDp());
                int endPaddingPx = CommonUtils.dp2px(divider.getLeftSideLine().getEndPaddingDp());
            ...
            if (divider.getTopSideLine().isHave()) {
                int lineWidthPx = CommonUtils.dp2px(divider.getTopSideLine().getWidthDp());
                int startPaddingPx = CommonUtils.dp2px(divider.getTopSideLine().getStartPaddingDp());
                int endPaddingPx = CommonUtils.dp2px(divider.getTopSideLine().getEndPaddingDp());
            ...
            if (divider.getRightSideLine().isHave()) {
                int lineWidthPx = CommonUtils.dp2px(divider.getRightSideLine().getWidthDp());
                int startPaddingPx = CommonUtils.dp2px(divider.getRightSideLine().getStartPaddingDp());
                int endPaddingPx = CommonUtils.dp2px(divider.getRightSideLine().getEndPaddingDp());
            ...
            if (divider.getBottomSideLine().isHave()) {
                int lineWidthPx = CommonUtils.dp2px(divider.getBottomSideLine().getWidthDp());
                int startPaddingPx = CommonUtils.dp2px(divider.getBottomSideLine().getStartPaddingDp());
                int endPaddingPx = CommonUtils.dp2px(divider.getBottomSideLine().getEndPaddingDp());
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        int left = divider.getLeftSideLine().isHave() ? CommonUtils.dp2px(divider.getLeftSideLine().getWidthDp()) : 0;
        int top = divider.getTopSideLine().isHave() ? CommonUtils.dp2px(divider.getTopSideLine().getWidthDp()) : 0;
        int right = divider.getRightSideLine().isHave() ? CommonUtils.dp2px(divider.getRightSideLine().getWidthDp()) : 0;
        int bottom = divider.getBottomSideLine().isHave() ? CommonUtils.dp2px(divider.getBottomSideLine().getWidthDp()) : 0;
