...
import cn.dr.basemvp.app.AppConstants;
import cn.dr.basemvp.app.BaseApplication;
import cn.dr.basemvp.net.converter.GsonConverterBodyFactory;
import cn.dr.basemvp.net.interceptor.CaheInterceptor;
import cn.dr.basemvp.net.interceptor.ParameterInterceptor;
import cn.dr.basemvp.utils.MD5Utils;
import cn.dr.basemvp.utils.cache.CacheManager;
...
public class BaseRetrofit {
    ...
    public static HashMap<String, Object> getRequestParams() {
        ...
        parameters.put("timestamp", currentTimeMillis);
        //md5签名
        String upperCase = MD5Utils.string2MD5(AppConstants.TOKEN + currentTimeMillis + AppConstants.APPID).toUpperCase();
        //翻转
        StringBuffer buf = new StringBuffer(upperCase);
        buf = buf.reverse();
        String reverse = buf.toString();
        //再md5加密
        String signature = MD5Utils.string2MD5(reverse).toUpperCase();
