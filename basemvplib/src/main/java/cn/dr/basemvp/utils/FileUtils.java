...
public class FileUtils {
    ...
    public static final String DOWNLOAD_DIR = "base360_doctor_download";
    public static final String CACHE_DIR = "base360_doctor_cache";
    public static final String ICON_DIR = "base360_doctor_icon";
